	...
	public class NavigationRenderer : UINavigationController, IVisualElementRenderer, IEffectControlProvider
	{
		...
		public override void ViewDidLayoutSubviews()
		{
			...
			PageController.ContainerArea =
				new Graphics.Rectangle(0, toolbar.Hidden ? 0 : toolbar.Frame.Height, modelSize.Width, modelSize.Height - trueBottom);

			if (!_queuedSize.IsZero)
			{
				Element.Layout(new Graphics.Rectangle(Element.X, Element.Y, _queuedSize.Width, _queuedSize.Height));
		...
		class Container : UIView
		{
			...
			public override void LayoutSubviews()
			{
				...
				{
					Graphics.Rectangle layoutBounds = new Graphics.Rectangle(IconWidth, 0, Bounds.Width - IconWidth, height);
