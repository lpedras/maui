...
namespace Microsoft.Maui.Controls.Compatibility.Platform.Android.AppCompat
{
	public class NavigationPageRenderer : VisualElementRenderer<NavigationPage>, IManageFragments, IOnClickListener, ILifeCycleState
	{
		...
		protected override void OnLayout(bool changed, int l, int t, int r, int b)
		{
			...
			PageController.ContainerArea = new Graphics.Rectangle(0, 0, Context.FromPixels(r - l), Context.FromPixels(containerHeight));
...
#pragma warning restore CS0618 // Type or member is obsolete
		...
		internal class Container : ViewGroup
		{
			...
			protected override void OnMeasure(int widthMeasureSpec, int heightMeasureSpec)
			{
				...
				Microsoft.Maui.Controls.Layout.LayoutChildIntoBoundingRegion(_child.Element, new Graphics.Rectangle(0, 0, width, request.Request.Height));
