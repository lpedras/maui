...
#pragma warning restore
		...
		void UpdateBounds()
		{
			...
			Element.FlyoutBounds = new Graphics.Rectangle(0, 0, masterSize.Width, masterSize.Height);
			Element.DetailBounds = new Graphics.Rectangle(0, 0, detailSize.Width, detailSize.Height);
		}
