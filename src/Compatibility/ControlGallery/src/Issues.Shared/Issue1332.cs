...
namespace Microsoft.Maui.Controls.Compatibility.ControlGallery.Issues
{
	...
	public class Issue1332 : TestContentPage
	{
		protected override void Init()
		{
			...
			AbsoluteLayout.SetLayoutBounds(red, new Graphics.Rectangle(0, 0, layoutWidth, layoutHeight));
				...
				Children =
				{
					...
					new Button
					{
						...
						Command = new Command(() => {
							...
							red.IsVisible = false;
							AbsoluteLayout.SetLayoutBounds(red, new Graphics.Rectangle(0, 0, layoutWidth, 150));
							red.IsVisible = true;
						})
					}
				}
			};
			AbsoluteLayout.SetLayoutBounds(stack, new Graphics.Rectangle(1, 0, layoutWidth / 2, 1));
			...
			AbsoluteLayout.SetLayoutBounds(desc, new Graphics.Rectangle(0, 0.5, 1, 0.5));
