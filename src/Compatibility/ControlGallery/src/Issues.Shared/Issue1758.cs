...
namespace Microsoft.Maui.Controls.Compatibility.ControlGallery.Issues
{
	...
	public class Issue1758 : ContentPage
	{
		...
		Layout Absolute()
		{
			...
			AbsoluteLayout.SetLayoutBounds(_list, new Graphics.Rectangle(0, 0, AbsoluteLayout.AutoSize, AbsoluteLayout.AutoSize));
			AbsoluteLayout.SetLayoutBounds(_button, new Graphics.Rectangle(0, 300, AbsoluteLayout.AutoSize, AbsoluteLayout.AutoSize));
		...
		async void Animate()
		{
			...
			await _button.LayoutTo(new Graphics.Rectangle(100, 100, 100, 100), 1000);
		}
	}
}
