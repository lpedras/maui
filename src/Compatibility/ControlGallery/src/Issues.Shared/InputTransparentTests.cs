...
namespace Microsoft.Maui.Controls.Compatibility.ControlGallery.Issues
{
	...
	public class InputTransparentTests : TestNavigationPage
	{
		...
		static ContentPage CreateTestPage(View view)
		{
			...
			abs.Children.Add(box, new Graphics.Rectangle(0, 0, 1, 1), AbsoluteLayoutFlags.All);

			abs.Children.Add(label, new Graphics.Rectangle(0, 0, AbsoluteLayout.AutoSize, AbsoluteLayout.AutoSize), AbsoluteLayoutFlags.PositionProportional);
			...
			abs.Children.Add(view, new Graphics.Rectangle(.5, .5, .5, .5), AbsoluteLayoutFlags.All);
